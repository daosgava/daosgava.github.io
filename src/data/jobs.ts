const JOBS = [
  ...
  },
  {
    ...
    description:
      "Yuxi Global is a company that offers nearshore staff augmentation services to companies in the U.S.",
    additional_info: "Worked for Convene.",
    responsibilities: [
      "Integrated various services, including Okta, Salesforce, and Square, into a web portal.",
      "Implemented new features for an online meeting app using the Amazon Chime SDK.",
    ],
    technologies: [
      "React.js",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "Zemoga is a company that offers nearshore staff augmentation services to companies in the U.S.",
    additional_info:
